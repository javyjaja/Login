...
namespace login.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            lista.Add(new combo { key = "Masculino", val = "Masculino" });
            lista.Add(new combo { key = "Femenino", val = "Femenino" });
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, Sexo = model.Sexo,
                    Estatus = model.Estatus, fecha = model.Fecha };
        ...
        [HttpPost]
        public ActionResult Editar(userViewModel u)
        {
            var db = new ApplicationDbContext();
            var o = db.Users.Where(x => x.IdAuto == u.Id).FirstOrDefault();

            o.UserName = u.Usuario;
            o.Email = u.Correo;
            o.Sexo = u.Sexo;
            o.Estatus = u.EstatusBool;
            db.SaveChanges();
